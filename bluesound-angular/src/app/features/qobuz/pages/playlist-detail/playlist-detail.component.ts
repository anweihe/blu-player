        ...
        <div class="playlist-header relative">
          ...
          <div class="relative p-4 sm:p-6 pt-4">
            ...
            <div class="flex gap-4 sm:gap-6 flex-col md:flex-row">
              ...
              <div
                class="playlist-cover w-36 h-36 sm:w-48 sm:h-48 md:w-56 md:h-56 overflow-hidden bg-bg-secondary flex-shrink-0 mx-auto md:mx-0 shadow-2xl cursor-zoom-in"
